...
function App() {
    ...
    return new Promise((resolve, reject) => {
        ...
        const interval = setInterval(() => {
            if (typeof window.pdfjsLib !== 'undefined') {
                ...
                clearInterval(interval);
                reject(new Error('PDF library kon niet worden geladen. Probeer de pagina te vernieuwen.'));
            }
            attempts++;
        }, 100);
    });
  ...
  const processFiles = useCallback(async (files) => {
    ...
    if (allData.length === 0 && hadParseableFiles && !error) {
        setError('De bestanden zijn gelezen, maar de tool kon de structuur niet herkennen.');
    }
...
`;
  ...
  return (
      <div className="parser-container">
        ...
        <div 
            className={`parser-card border-2 border-dashed transition-colors ${isDraggingOver ? 'border-blue-500 bg-blue-50' : 'border-gray-300'}`}
            onDrop={handleDrop}
        ...
        >
          ...
          <div className="flex justify-center items-center flex-col text-center">
            <svg className="parser-upload-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg>
          ...
          <div className="bg-white shadow-lg rounded-xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="parser-table">
                <thead className="parser-table-head">
                  <tr>
